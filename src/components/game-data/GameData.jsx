...
function GameData () {
    ...
    const checkIfExists = async () => {
        const response = await fetch(`https://game-on-server.herokuapp.com/userWishlist/${email}`);
        ...
        if (!filteredWishlist) {
            ...
            const response = await axios.post(`https://game-on-server.herokuapp.com/wishlist/${email}`, listedGame)
            .catch((err) => {
                if(err && err.response)
